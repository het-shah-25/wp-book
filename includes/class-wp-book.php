...
class Wp_Book {
    ...
    private function define_admin_hooks() {
        ...
        $this->loader->add_action('init', $plugin_admin, 'create_category_tax');
        // Hook for registering 'Book Tags' non-hierarchical taxonomy
        $this->loader->add_action('init', $plugin_admin, 'create_tag_tax');
        //Hook for create a matabox
        $this->loader->add_action('add_meta_boxes', $plugin_admin, 'wp_book_add_meta_box');
        //save the mata box
        $this->loader->add_action('save_post_book', $plugin_admin, 'wp_book_save_book_meta');
        //create custom table
        ...
        //save mata data information
        $this->loader->add_action('save_post', $plugin_admin, 'save_book_name_to_table');
        //dashboard widget
        $this->loader->add_action('wp_dashboard_setup', $plugin_admin, 'wp_book_register_dashboard_widget');
        //setting page
        $this->loader->add_action('admin_menu', $plugin_admin, 'wp_book_add_settings_page');
        $this->loader->add_action('admin_init', $plugin_admin, 'wp_book_register_settings');
